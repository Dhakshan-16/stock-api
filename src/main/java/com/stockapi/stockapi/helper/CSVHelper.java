package com.stockapi.stockapi.helper;
...
public class CSVHelper {
    ...
    static String[] HEADERs = { "quarter","stock","date","open","high","low","close","volume","percent_change_price","percent_change_volume_over_last_wk",
